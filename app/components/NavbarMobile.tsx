    ...
    <div className="flex md:hidden items-center gap-2">
      ...
      {open && (
        <>
          ...
          {/* Panel */}
          <div className="fixed right-0 top-14 z-50 h-[calc(100dvh-56px)] w-72 border-l border-border bg-surface flex flex-col">
            {/* Nav links */}
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2.5 rounded-lg px-3 py-2.5 text-sm text-text-muted transition-colors hover:bg-border/40 hover:text-red-400 mt-auto"
                  >
                    <LogOut size={15} />
                    Sign out
                  </button>
