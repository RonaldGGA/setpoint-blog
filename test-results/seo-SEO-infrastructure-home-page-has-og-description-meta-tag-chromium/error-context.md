...
- Name: seo.spec.ts >> SEO infrastructure >> home page has og:description meta tag
- Location: e2e\seo.spec.ts:49:7
...
Locator: locator('meta[property="og:description"]')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('meta[property="og:description"]')
